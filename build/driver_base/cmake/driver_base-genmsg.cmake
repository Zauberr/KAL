...
set(MSG_I_FLAGS "-Idriver_base:/home/kal5-2/rammbo/src/driver_base/driver_base/msg;-Istd_msgs:/opt/mrtros/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kal5-2/rammbo/src/driver_base/driver_base/msg/ConfigString.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/kal5-2/rammbo/src/driver_base/driver_base/msg/ConfigString.msg" ""
)

get_filename_component(_filename "/home/kal5-2/rammbo/src/driver_base/driver_base/msg/SensorLevels.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/kal5-2/rammbo/src/driver_base/driver_base/msg/SensorLevels.msg" ""
)

get_filename_component(_filename "/home/kal5-2/rammbo/src/driver_base/driver_base/msg/ConfigValue.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/kal5-2/rammbo/src/driver_base/driver_base/msg/ConfigValue.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/driver_base)
  install(CODE "execute_process(COMMAND \"/opt/mrtsoftware/release/lib/mrt-build-tools/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/driver_base\")")
  # install generated code
  install(
