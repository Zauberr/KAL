...
private:
    ...
    //const int *erosion(const int *input);
    //const int *dilation(const int *input);
    //void sum(std::vector<int8_t> grid);
    ...
    //for transfomr
    sensor_msgs::CameraInfo camera_info_globa; //I don't know, if I can use it in this way.
    ...
    //Must man do it in this way? can I do it like obove?
    //for tf2
