...
StereoCameraModel::StereoCameraModel() : Q_(0.0) {
    Q_(0, 0) = Q_(1, 1) = 1.0;
}
...
bool StereoCameraModel::fromCameraInfo(const sensor_msgs::CameraInfo& left, const sensor_msgs::CameraInfo& right) {
...
void StereoCameraModel::projectDisparityImageTo3d(const cv::Mat& disparity,
                                                  cv::Mat& point_cloud,
