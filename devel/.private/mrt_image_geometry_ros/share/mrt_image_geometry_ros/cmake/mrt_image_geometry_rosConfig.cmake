...
if(NOT "/home/kal5-2/rammbo/src/mrt_image_geometry_ros/include;/opt/mrtsoftware/release/include;/opt/mrtsoftware/release/include/opencv " STREQUAL " ")
  set(mrt_image_geometry_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/kal5-2/rammbo/src/mrt_image_geometry_ros/include;/opt/mrtsoftware/release/include;/opt/mrtsoftware/release/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrt_image_geometry_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-2/rammbo/src/mrt_image_geometry_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-2/rammbo/devel/.private/mrt_image_geometry_ros/lib;/home/kal5-2/rammbo/devel/lib;/opt/mrtros/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib)
