...
if("TRUE" STREQUAL "TRUE")
  set(mrt_cmake_modules_SOURCE_PREFIX /home/kal5-2/rammbo/src/mrt_cmake_modules)
  set(mrt_cmake_modules_DEVEL_PREFIX /home/kal5-2/rammbo/devel/.private/mrt_cmake_modules)
  ...
  set(mrt_cmake_modules_INSTALL_PREFIX /home/kal5-2/rammbo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrt_cmake_modules' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-2/rammbo/src/mrt_cmake_modules/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-2/rammbo/devel/.private/mrt_cmake_modules/lib;/home/kal5-2/rammbo/devel/lib;/opt/mrtros/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib)
