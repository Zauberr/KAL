...
if(NOT "/home/kal5-2/rammbo/src/stargazer/include;/usr/include/eigen3;/usr/include;/opt/mrtsoftware/release/include;/opt/mrtsoftware/release/include/opencv " STREQUAL " ")
  set(stargazer_INCLUDE_DIRS "")
  set(_include_dirs "/home/kal5-2/rammbo/src/stargazer/include;/usr/include/eigen3;/usr/include;/opt/mrtsoftware/release/include;/opt/mrtsoftware/release/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stargazer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-2/rammbo/src/stargazer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-2/rammbo/devel/.private/stargazer/lib;/home/kal5-2/rammbo/devel/lib;/opt/mrtros/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib)
