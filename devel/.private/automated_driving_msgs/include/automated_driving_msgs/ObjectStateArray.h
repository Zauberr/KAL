// Generated by gencpp from file automated_driving_msgs/ObjectStateArray.msg
// DO NOT EDIT!


#ifndef AUTOMATED_DRIVING_MSGS_MESSAGE_OBJECTSTATEARRAY_H
#define AUTOMATED_DRIVING_MSGS_MESSAGE_OBJECTSTATEARRAY_H
...
struct ObjectStateArray_
{
  typedef ObjectStateArray_<ContainerAllocator> Type;

  ObjectStateArray_()
    : header()
    , objects()  {
    }
  ObjectStateArray_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , objects(_alloc)  {
  (void)_alloc;
    }
  ...
  _header_type header;
   ...
   typedef std::vector< ::automated_driving_msgs::ObjectState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::automated_driving_msgs::ObjectState_<ContainerAllocator> >::other >  _objects_type;
  ...
  typedef boost::shared_ptr< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectStateArray_

typedef ::automated_driving_msgs::ObjectStateArray_<std::allocator<void> > ObjectStateArray;

typedef boost::shared_ptr< ::automated_driving_msgs::ObjectStateArray > ObjectStateArrayPtr;
typedef boost::shared_ptr< ::automated_driving_msgs::ObjectStateArray const> ObjectStateArrayConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
{
  ...
  static const char* value(const ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa5c500e1a3ee9d84ULL;
  static const uint64_t static_value2 = 0x630928c547daf2f1ULL;
};

template<class ContainerAllocator>
struct DataType< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Message an array of object states (output of localization management)\n"
"# License: BSD\n"
"\n"
"# Header\n"
"Header header\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::automated_driving_msgs::ObjectStateArray_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.objects.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::automated_driving_msgs::ObjectState_<ContainerAllocator> >::stream(s, indent + "    ", v.objects[i]);
    }
  }
};
...
#endif // AUTOMATED_DRIVING_MSGS_MESSAGE_OBJECTSTATEARRAY_H
