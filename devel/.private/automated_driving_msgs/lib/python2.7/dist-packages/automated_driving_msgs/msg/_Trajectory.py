...
"""autogenerated by genpy from automated_driving_msgs/Trajectory.msg. Do not edit."""
import sys
...
class Trajectory(genpy.Message):
  _md5sum = "dfe3d1282121d63bd281a7dc32763b51"
  _type = "automated_driving_msgs/Trajectory"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Message representing a trajectory as consecutive motion states
...
float32 y
float32 z"""
  __slots__ = ['id','probability','motion_states','set_based_position_uncertainty']
  _slot_types = ['uint32','float32','automated_driving_msgs/MotionState[]','geometry_msgs/Polygon[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,probability,motion_states,set_based_position_uncertainty
    ...
    if args or kwds:
      ...
      if self.probability is None:
        self.probability = 0.
      if self.motion_states is None:
        self.motion_states = []
      if self.set_based_position_uncertainty is None:
        self.set_based_position_uncertainty = []
    else:
      self.id = 0
      self.probability = 0.
      self.motion_states = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.motion_states)
      buff.write(_struct_I.pack(length))
      for val1 in self.motion_states:
        _v1 = val1.header
      ...
      length = len(self.set_based_position_uncertainty)
      buff.write(_struct_I.pack(length))
      for val1 in self.set_based_position_uncertainty:
  ...
  def deserialize(self, str):
    ...
    try:
      if self.motion_states is None:
        self.motion_states = None
      if self.set_based_position_uncertainty is None:
        self.set_based_position_uncertainty = None
      end = 0
      _x = self
      start = end
      end += 8
      ...
      for i in range(0, length):
        val1 = automated_driving_msgs.msg.MotionState()
        _v15 = val1.header
        start = end
        end += 4
        ...
        self.motion_states.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.set_based_position_uncertainty = []
      for i in range(0, length):
        ...
        self.set_based_position_uncertainty.append(val1)
      return self
