...
class BasicSafetyMessage {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.header = null;
      this.communication_header = null;
      this.object_state = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('communication_header')) {
        this.communication_header = initObj.communication_header
      }
      else {
        this.communication_header = new AdditionalHeaderForCommunication();
      }
      if (initObj.hasOwnProperty('object_state')) {
        this.object_state = initObj.object_state
      }
      else {
        this.object_state = new ObjectState();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [communication_header]
    bufferOffset = AdditionalHeaderForCommunication.serialize(obj.communication_header, buffer, bufferOffset);
    // Serialize message field [object_state]
    bufferOffset = ObjectState.serialize(obj.object_state, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BasicSafetyMessage(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [communication_header]
    data.communication_header = AdditionalHeaderForCommunication.deserialize(buffer, bufferOffset);
    // Deserialize message field [object_state]
    data.object_state = ObjectState.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += AdditionalHeaderForCommunication.getMessageSize(object.communication_header);
    length += ObjectState.getMessageSize(object.object_state);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BasicSafetyMessage(null);
    ...
    if (msg.communication_header !== undefined) {
      resolved.communication_header = AdditionalHeaderForCommunication.Resolve(msg.communication_header)
    }
    else {
      resolved.communication_header = new AdditionalHeaderForCommunication()
    }

    if (msg.object_state !== undefined) {
      resolved.object_state = ObjectState.Resolve(msg.object_state)
    }
    else {
      resolved.object_state = new ObjectState()
    }
...
module.exports = BasicSafetyMessage;
