...
if("TRUE" STREQUAL "TRUE")
  set(timestamp_tools_SOURCE_PREFIX /home/kal5-2/rammbo/src/driver_base/timestamp_tools)
  set(timestamp_tools_DEVEL_PREFIX /home/kal5-2/rammbo/devel/.private/timestamp_tools)
  ...
  set(timestamp_tools_INSTALL_PREFIX /home/kal5-2/rammbo/install)
...
if(NOT "/home/kal5-2/rammbo/src/driver_base/timestamp_tools/include " STREQUAL " ")
  set(timestamp_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/kal5-2/rammbo/src/driver_base/timestamp_tools/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'timestamp_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-2/rammbo/src/driver_base/timestamp_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-2/rammbo/devel/.private/timestamp_tools/lib;/home/kal5-2/rammbo/devel/lib;/opt/mrtros/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib)
